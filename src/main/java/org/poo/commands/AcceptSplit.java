...
public final class AcceptSplit implements Command {
    private int timestamp;
    private Database database;
    private String mail;
    private String type;

    public AcceptSplit(final String mail, final String type,
    ...
    public ObjectNode execute() {
        ...
        if (owner == null) {
            ...
            result.put("command", "acceptSplitPayment");
        ...
        report.userActioned(searchedAccount.getIban(), true);
